...
jbyteArray
JNICALL
Java_com_elink_health_mediciner_utils_SecurityUtil_getKeyValue(JNIEnv *env, jclass type) {
...
jbyteArray
JNICALL
Java_com_elink_health_mediciner_utils_SecurityUtil_getIv(JNIEnv *env, jclass type) {
